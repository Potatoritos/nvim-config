...
hl('StatusReplace', { bg = colors.bg, fg = colors.fg_dark, bold = true })
hl('StatusInsert', { bg = colors.bg, fg = colors.fg_dark, bold = true })
hl('StatusVisual', { bg = colors.bg, fg = colors.fg_dark, bold = true })
hl('StatusTerminal', { bg = colors.bg, fg = colors.fg_dark, bold = true })
hl('StatusNormal', { bg = colors.bg, fg = colors.fg_dark, bold = true })
hl('StatusCommand', { bg = colors.bg, fg = colors.fg_dark, bold = true })
hl('StatusSelect', { bg = colors.bg, fg = colors.fg_dark, bold = true })
hl('StatusOther', { bg = colors.bg, fg = colors.fg_dark, bold = true })
...
hl('@variable.builtin.python', { fg = colors.fg, italic = true })
