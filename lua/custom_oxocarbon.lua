...
hl('@include', { fg = colors.blue })
hl('@exception', { fg = colors.blue_light })
hl('@type', { link = 'Type' })
...
hl('GitSignsChangedelete', { link = 'GitSignsDelete' })
...
hl('GitSignsStagedUntracked', { link = 'GitSignsDelete' })
hl('GitSignsUntracked', { link = 'GitSignsAdd' })
hl('GitSignsCurrentLineBlame', { link = 'GitSignsUntracked' })
